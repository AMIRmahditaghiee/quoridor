...
def two_player_game():
    ...
    while not game_is_over:
        ...
        if turn == 1:
            player_1_walls = player_turn(player_1_place, wall_places, player_1_walls, [player_2_place], turn)
            #pass the turn
            turn = 2
        #if it's 2nd player turn
        elif turn == 2:
            player_2_walls = player_turn(player_2_place, wall_places, player_2_walls, [player_1_place], turn)
            #pass the turn
            turn = 1
...
def four_player_game():
    ...
    while not game_is_over:
        ...
        #if it's 1st player turn
        if turn == 1:
            player_1_walls = player_turn(player_1_place, wall_places, player_1_walls, [player_2_place, player_3_place, player_4_place], turn)
            #pass the turn
            turn = 2
        #if it's 2nd player turn
        elif turn == 2:
            player_2_walls = player_turn(player_2_place, wall_places, player_2_walls, [player_1_place, player_3_place, player_4_place], turn)
            #pass the turn
            turn = 3
        #if it's 3rd player turn
        elif turn == 3:
            player_3_walls = player_turn(player_3_place, wall_places, player_3_walls, [player_1_place, player_2_place, player_4_place], turn)
            #pass the turn
            turn = 4
        #if it's 4th player turn
        elif turn == 4:
            player_4_walls = player_turn(player_4_place, wall_places, player_4_walls, [player_1_place, player_2_place, player_3_place], turn)
            #pass the turn
            turn = 1
        #if walls are place legally
